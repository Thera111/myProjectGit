...
├── performance_tests/    # 性能测试数据和结果
├── 性能测试报告.md        # 性能测试报告
└── 数据结构大作业题目：热词统计与分析系统.md  # 作业题目说明
...
- 编译程序
- 生成小、中、大规模测试数据
- 运行性能测试并收集指标（时间、内存、CPU使用率）
- 生成性能汇总报告

### 性能指标

基于 AMD EPYC 7763 处理器的测试结果：

| 负载规模 | 句子数 | 处理时间 | 内存占用 | 吞吐量 |
|---------|--------|---------|---------|--------|
| 小规模 | 100 | ~0.5秒 | ~150MB | 182句/秒 |
| 中规模 | 1,000 | ~0.5秒 | ~150MB | 1,887句/秒 |
| 大规模 | 5,000 | ~0.6秒 | ~151MB | 8,772句/秒 |

### 性能测试文档

本项目提供完整的性能测试文档和工具：

- **性能测试指南**: [性能测试指南.md](性能测试指南.md) - 详细的测试方法、工具使用和报告撰写指导
- **性能测试报告**: [性能测试报告.md](性能测试报告.md) - 完整的性能测试报告示例
- **报告模板**: [性能测试报告模板.md](性能测试报告模板.md) - 标准化的报告模板
- **测试数据说明**: [performance_tests/README.md](performance_tests/README.md) - 测试数据和结果说明
